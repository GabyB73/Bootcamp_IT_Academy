...
public class FactorySpain implements AddressPhoneFactory {
    Scanner sc = new Scanner(System.in);
    @Override
    public Address createAddress() {
        // Implementa la lógica para crear una dirección española.
    ...
    public PhoneNumber createPhoneNumber() {
        // Implementa la lógica para crear un número de teléfono español.
